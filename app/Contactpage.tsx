  ...
  return (
    <main style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}>
      ...
      <section className="video-hero mt-24">
        ...
        <img src="/images/banner.png" alt="Contact" className="video-hero-bg" />
      ...
      <section className="py-24 bg-white dark:bg-darkmode">
        <div className="container overflow-hidden">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-20 md:gap-12 xl:gap-10 2xl:gap-14 items-stretch">
            <ContactForm />
            <ContactMap />
          </div>
        </div>
