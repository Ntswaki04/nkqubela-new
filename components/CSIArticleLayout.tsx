    ...
    <main className="pt-32 pb-20">
      ...
      <section className="container max-w-5xl mx-auto px-4 pt-6">
        <div className="text-center mb-12" data-aos="fade-up">
          <div
            className="inline-block px-4 py-1.5 border border-primary/20 rounded-full mb-6"
        ...
        {/* Featured Image */}
        <div
          className="w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl mb-16"
          data-aos="zoom-in"
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            ...
            className={`w-full h-full object-cover object-center ${
              featuredImage === "/images/mec-awards-golf-group.jpg"
                ? "[object-position:50%_50%] md:[object-position:50%_25%]"
                : ""
            }`}
          />
        </div>
      ...
      <section className="container max-w-4xl mx-auto px-4">
        <div className="flex flex-col gap-12">
          ...
          <div className="flex-grow border-b border-gray-100 dark:border-gray-800 pb-16">
            <article
              className="article-content article-drop-cap"
              data-aos="fade-up"
            >
              {children}
            </article>
      ...
      <section className="container max-w-4xl mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-center gap-4">
          {prevLink && (
            <Link
              href={prevLink}
              className="article-nav-button-prev border border-[#00296D] bg-white text-[#00296D] hover:bg-[#00296D] hover:text-white font-bold py-2.5 px-10 rounded-full text-center transition-colors text-sm min-w-[200px]"
            >
              Previous Initiative
            </Link>
          )}
          {nextLink && (
            <Link
              href={nextLink}
              className="article-nav-button-next bg-[#00296D] text-white hover:bg-white hover:text-black border border-[#00296D] font-bold py-2.5 px-10 rounded-full text-center transition-colors text-sm min-w-[200px]"
            >
              Next Initiative
            </Link>
          )}
