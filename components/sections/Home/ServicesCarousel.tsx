...
export default function ServicesCarousel({
  ...
  const createExtendedColumn = (basePattern: string[]) => {
  ...
  const getSlidePattern = (slideIndex: number) => {
    ...
    return {
      left: createExtendedColumn(base.left),
      right: createExtendedColumn(base.right),
    };
  };
  ...
  }, [services.length, autoPlayInterval]);
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 pt-8 lg:pt-10 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Our enterprise software solutions are designed to streamline your
            business processes, improve productivity, and drive growth.
          </p>
        </div>
