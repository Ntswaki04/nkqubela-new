        ...
        <div className="grid lg:grid-cols-2 items-center gap-8 md:gap-12">
          ...
          <div className="order-1 lg:order-2 space-y-4" data-aos="fade-left">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl">
              As a leading systems integrator with over 20 years of experience,
              we provide customised solutions that help our clients solve
              complex problems and achieve their business goals.
            </p>
