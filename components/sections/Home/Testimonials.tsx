      ...
      <div className="container">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Trusted partnerships built on reliable delivery, measurable impact,
            and long-term support.
          </p>
        </div>
        <div ref={swiperRef} className="swiper testimonialSwiper">
                ...
                <div className="text-YellowRating flex justify-center text-2xl gap-1">
                  {[...Array(5)].map((_, i) => (
                    <span
                      key={i}
                      className="iconify"
                      data-icon="ic:round-star"
                    ></span>
                  ))}
                </div>
                <h3 className="text-2xl md:text-3xl font-medium italic dark:text-white leading-relaxed">
                  Nkqubela Technologies provided us with a seamless systems
                  integration that significantly improved our operational
                  efficiency. Their expertise is unmatched.
                </h3>
                <div className="flex items-center justify-center gap-4 pt-6">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-SlateBlueText dark:text-darktext">
                      Operations Manager @ Corporate SA
                    </p>
                  </div>
                </div>
              </div>
