...
export default function ContactMap() {
  return (
    <div className="pt-12 xl:pt-0 h-full" data-aos="fade-up">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-8 h-[640px] xl:h-[620px]">
        <div className="rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 h-full">
          <iframe
