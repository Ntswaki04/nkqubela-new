...
export default function CSIInitiativesGrid({
  isDark,
}: CSIInitiativesGridProps) {
  ...
  return (
    <section
      ...
      className="py-24 bg-white dark:bg-darkmode overflow-hidden"
    >
      <div className="container">
        ...
        <p
          className="text-gray-500 dark:text-gray-400 text-lg mb-14"
          data-aos="fade-up"
          data-aos-delay="60"
        >
          A look at the programmes and projects we&apos;ve invested in across
          our communities.
        </p>
            ...
            >
              ...
              <div className="p-8 space-y-4">
                <h3
                  ...
                  style={{
                    color:
                      hoveredCard === init.slug + i ? hoverColour : undefined,
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                  ...
                  <div
                    className="inline-block px-3 py-1 border border-primary/20 rounded-full"
                    ...
                    style={{
                      backgroundColor:
                        hoveredCard === init.slug + i
                          ...
                          : "transparent",
                      color:
                        hoveredCard === init.slug + i ? "#ffffff" : "#9ca3af",
                      transform:
                        hoveredCard === init.slug + i
                          ? "scale(1.12)"
                          : "scale(1)",
        ...
        <div className="flex border-t border-gray-200 dark:border-gray-700 mt-0">
          ...
          >
            <div
              ...
              style={{
                backgroundColor:
                  hoveredPrev && currentPage > 1 ? "#072B61" : "transparent",
                color:
                  hoveredPrev && currentPage > 1
                    ? "#ffffff"
                    : isDark
                      ...
                      : "#9ca3af",
                transform:
                  hoveredPrev && currentPage > 1 ? "scale(1.1)" : "scale(1)",
              }}
            >
          ...
          <button
            ...
            style={{
              backgroundColor:
                hoveredNext && currentPage < totalPages
                  ? isDark
                    ? "rgba(255,255,255,0.05)"
                    : "#f9fafb"
                  : "transparent",
